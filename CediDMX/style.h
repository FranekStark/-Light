...
.custom-control-input {
  ...
  .custom-control-input:focus ~ .custom-control-label::before {
    box-shadow: 0 0 0 1px #f3f3f3, 0 0 0 0.2rem rgba(0, 115, 230, 0.25); }
...
.custom-select {
  ...
  .custom-select:focus {
    border-color: #67b3ff;
    outline: 0;
    box-shadow: inset 0 1px 2px rgba(0, 0, 0, 0.075), 0 0 5px rgba(103, 179, 255, 0.5); }
...
.bg-gradient {
  overflow: hidden;
  color: #fff;
  background: linear-gradient(-30deg, #000000 0%, #0073e6 50%, #0073e6 100%); }
...
.filter-gradient {
  ...
  .filter-gradient:before {
    ...
    height: 100%;
    content: ' ';
    background: linear-gradient(-30deg, rgba(0, 0, 0, 0.9) 0%, rgba(0, 115, 230, 0.9) 50%, rgba(0, 115, 230, 0.95) 100%); }
...
.filter-fade-in {
  ...
  .filter-fade-in:before {
    ...
    height: 100%;
    content: ' ';
    background: linear-gradient(#f3f3f3, rgba(243, 243, 243, 0.8), rgba(243, 243, 243, 0.1), rgba(243, 243, 243, 0)); }
)=====";
#endif
